...
const Square1: React.FC<Square1Props> = ({ col, width, height }) => {
  useEffect(() => {
    const square = document.querySelector(".background-square1") as HTMLElement;
  ...
  return (
    <div
      className={`background-square1 rounded fixed ${width} ${height} ${col} -z-10`}
    ></div>
  );
};
