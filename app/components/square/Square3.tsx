...
const Square3: React.FC<Square1Props> = ({ col, width, height }) => {
  useEffect(() => {
    const square = document.querySelector(".background-square3") as HTMLElement;
  ...
  return (
    <div
      className={`background-square3 rounded fixed ${width} ${height} ${col} -z-10`}
    ></div>
  );
};
