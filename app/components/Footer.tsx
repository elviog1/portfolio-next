  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 flex-wrap ">
        ...
        <a
          target="_blank"
          className="hover:animate-pulse duration-500 hover:text-rose-600"
          href="https://instagram.com/pochuchui"
        >
          <AiFillInstagram />
        </a>
        <a
          target="_blank"
          className="hover:animate-pulse duration-200 hover:text-blue-500"
        ...
        <a
          target="_blank"
          className="hover:animate-pulse duration-200 hover:text-red-600"
          href="https://www.youtube.com/channel/UC7UHsR2jNrMieWknwVJvP7Q"
        >
          <AiFillYoutube />
        </a>
        <a
          target="_blank"
          className="hover:animate-pulse duration-200 hover:text-blue-600"
        ...
        <a
          target="_blank"
          className="hover:animate-pulse duration-200 hover:text-green-600"
